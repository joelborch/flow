...
export const Attachment = z.object({
  ...
  filename: z.string(),
  r2Key: z.string(),
  storageProvider: z.enum(["r2", "drive"]).default("r2"),
  driveFileId: z.string().nullable().default(null),
  driveWebViewLink: z.url().nullable().default(null),
  driveDestination: z.enum(["shared", "private"]).nullable().default(null),
  migrationState: z.enum(["r2", "cleanup_pending", "complete"]).default("r2"),
